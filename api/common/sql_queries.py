...
CREATE_USER_SQL = '''INSERT INTO public.projects_user (
            id,
            created,
            modified,
            email,
...
CREATE_USER_EXTERNAL_ACCOUNT_SQL = '''INSERT INTO public.projects_userexternalaccount (
            id,
            created,
            modified,
            external_system_id,
...
INSERT_USER_GROUP_MEMBERSHIP_SQL = '''INSERT INTO public.projects_usergroupmembership (
                id,
                created,
                modified,
                user_id,
...
CREATE_USER_PROJECT_SQL = '''INSERT INTO public.projects_userproject (
        id,
        created,
        modified,
        user_id,
...
CREATE_USER_TASK_SQL = '''INSERT INTO public.projects_usertask (
        id,
        created,
        modified,
        user_project_id,
